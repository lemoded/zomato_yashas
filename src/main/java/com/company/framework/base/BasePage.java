...
public abstract class BasePage {
    ...
    protected void javaScriptClick(WebElement element) {
        ((JavascriptExecutor) driver()).executeScript(
            "if (typeof arguments[0].click === 'function') { arguments[0].click(); } " +
            "else { var ev = new MouseEvent('click', { bubbles: true, cancelable: true, view: window }); arguments[0].dispatchEvent(ev); }",
            element);
